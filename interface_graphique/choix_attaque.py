...
class Ui_Choix_attaque(object):
    def setupUi(self, Choix_attaque):
        ...
        self.txt_degats_att_spe.setGeometry(QtCore.QRect(50, 150, 121, 41))
        font = QtGui.QFont()
        ...
        self.txt_degats_att_neutre.setGeometry(QtCore.QRect(380, 150, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, Choix_attaque):
        ...
        self.txt_degats_att_spe.setText(_translate("Choix_attaque", "Dégats inffligés :  "))
        self.nbr_degat_att_spe.setText(_translate("Choix_attaque", "XX"))
        self.txt_degats_att_neutre.setText(_translate("Choix_attaque", "Dégats inffligés :"))
