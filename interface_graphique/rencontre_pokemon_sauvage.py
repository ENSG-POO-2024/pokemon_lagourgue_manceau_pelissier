...
class Ui_rencontre_pokemon_sauvage(object):
    def setupUi(self, rencontre_pokemon_sauvage):
        ...
        self.label = QtWidgets.QLabel(rencontre_pokemon_sauvage)
    ...
    def retranslateUi(self, rencontre_pokemon_sauvage):
        ...
        rencontre_pokemon_sauvage.setWindowTitle(_translate("rencontre_pokemon_sauvage", "Pokémon détecté !"))
        ...
        self.label.setText(_translate("rencontre_pokemon_sauvage", "Un nom_pokémon sauvage apparaît !"))
